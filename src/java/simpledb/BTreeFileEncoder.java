    ...
    private static void cleanUpEntries(ArrayList<ArrayList<BTreeEntry>> entries, BTreeFile bf, int nentries,
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            if (size <= nentries) {
                ...
                byte[] internalPageBytes =
                        convertToInternalPage(entries.get(i), npagebytes, keyType, childPageCategory);
                ...
                byte[] secondToLastPageBytes =
                        convertToInternalPage(secondToLastPg, npagebytes, keyType, childPageCategory);
                ...
                BTreeEntry pushUpEntry =
                        new BTreeEntry(entries.get(i).get(size / 2).getKey(), secondToLastPid, lastPid);
