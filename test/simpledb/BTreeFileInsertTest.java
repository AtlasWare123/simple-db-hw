...
public class BTreeFileInsertTest extends SimpleDbTestBase {
    ...
    public void testSplitLeafPages() throws Exception {
        ...
        BTreeLeafPage leftPage =
                BTreeUtility.createRandomLeafPage(leftPageId, 2, keyField, 0, BTreeUtility.MAX_RAND_VALUE);
    ...
    public void testSplitInternalPages() throws Exception {
        ...
        BTreeInternalPage leftPage = BTreeUtility
                .createRandomInternalPage(leftPageId, keyField, BTreePageId.LEAF, 0, BTreeUtility.MAX_RAND_VALUE, 3);
