...
public class JoinOptimizerTest extends SimpleDbTestBase {
    ...
    public void estimateJoinCostTest() throws ParsingException {
        ...
        JoinOptimizer jo;
        Parser p = new Parser();
        jo = new JoinOptimizer(p.generateLogicalPlan(tid,
                "SELECT * FROM " + tableName1 + " t1, " + tableName2 + " t2 WHERE t1.c1 = t2.c2;"),
                new Vector<LogicalJoinNode>());
        // 1 join 2
        LogicalJoinNode equalsJoinNode =
                new LogicalJoinNode(tableName1, tableName2, Integer.toString(1), Integer.toString(2),
                        Predicate.Op.EQUALS);
    ...
    public void estimateJoinCardinality() throws ParsingException {
        ...
        cardinality = j.estimateJoinCardinality(
                ...
                stats2.estimateTableCardinality(0.2), true, false, TableStats.getStatsMap());
        ...
        cardinality = j.estimateJoinCardinality(
                new LogicalJoinNode("t1", "t2", "c" + Integer.toString(3), "c" + Integer.toString(4),
                        Predicate.Op.EQUALS), stats1.estimateTableCardinality(0.8),
                stats2.estimateTableCardinality(0.2), false, true, TableStats.getStatsMap());
    ...
    public void orderJoinsTest() throws ParsingException, IOException, DbException, TransactionAbortedException {
        ...
        // outermost table.
        Assert.assertFalse(result.get(2).t2Alias == "hobbies" && (result.get(0).t1Alias == "hobbies"
    ...
    public void bigOrderJoinsTest() throws IOException, DbException, TransactionAbortedException, ParsingException {
        ...
        HeapFile smallHeapFileA =
                SystemTestUtil.createRandomHeapFile(2, 100, Integer.MAX_VALUE, null, smallHeapFileTuples, "c");
